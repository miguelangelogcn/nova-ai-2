  ...
  return (
    <div className="w-full">
        <div className="grid md:grid-cols-2 gap-8 items-center min-h-[250px]">
            ...
            >
                <div style={{ perspective: '1000px', width: `${CUBE_FACE_SIZE}px`, height: `${CUBE_FACE_SIZE}px` }}>
                    <div
                        ref={cubeRef}
            ...
            {/* Right side: Content */}
            <div key={activeIndex} className="animate-in fade-in-50 duration-500">
                <div className="p-4 rounded-lg bg-muted/50 border h-full min-h-[200px]">
